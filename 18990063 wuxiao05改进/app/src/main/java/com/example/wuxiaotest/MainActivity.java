package com.example.wuxiaotest;
...
import com.example.wuxiaotest.bean.UserInfo;
import com.example.wuxiaotest.database.UserDBHelper;
import com.example.wuxiaotest.util.DateUtil;
import com.example.wuxiaotest.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener , CompoundButton.OnCheckedChangeListener {
    ...
    private String[] typeArray = {"个人用户", "公司用户","18990063 武潇"};
