...
public class TabFirstFragment extends Fragment implements TabLayout.OnTabSelectedListener {
...
//        tab_title.addTab(tab_title.newTab().setText(mTitleArray.get(1)));
        ...
        //tab_title.addOnTabSelectedListener((TabLayout.OnTabSelectedListener) mContext);
        //tab_title.addOnTabSelectedListener((TabLayout.BaseOnTabSelectedListener) mContext);  //可能会错
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        ((AppCompatActivity) getActivity()).getMenuInflater().inflate(R.menu.menu_overflow, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) { // 点击了工具栏左边的返回箭头
            ...
            Toast.makeText(mContext, "当前刷新时间: " + DateUtil.getNowDateTime("yyyy-MM-dd HH:mm:ss")
           , Toast.LENGTH_LONG).show();
            return true;
        } else if (id == R.id.menu_about) { // 点击了关于菜单项
            Toast.makeText(mContext, "这个是标签布局的演示demo", Toast.LENGTH_LONG).show();
            return true;
