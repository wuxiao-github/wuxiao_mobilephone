...
public class GoodsInfo {
    ...
    private static String[] gridTitleArray = {"苏宁", "IG", "RNG", "SKT",
            "C9", "G2", "OMG", "LGD", "ROX", "GRF"};
    ...
    private static String[] stagTitleArray = {"防弹武僧", "武神", "SSG纳尔", "KDA阿卡丽", "三昧真火", "夜刃",
            "龙的传人", "SSW雷恩加尔", "KDA阿狸", "KDA卡莎", "星守 索拉卡", "未来战士卢锡安", "K/DA ALL OUT 卡莎", "西部魔影赛纳",
            "西部魔影 赫卡雷姆", "西部魔影 德莱厄斯", "海克斯科技 雷克顿", "海克斯科技波比", "西部魔影 锤石", "西部魔影 卢锡安", "未来战士瑞雯", "未来战士 菲奥娜", "冰雪节限定波比"};
